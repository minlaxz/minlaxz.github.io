...
const name = "Min Min Latt (minlaxz)";
...
const Layout = ({ children, home }) => {
 ...
 return (
  ...
  >
   ...
   <header className={styles.header}>
    {home ? (
     <>
      ...
      />
      <h3
       className="text-1xl font-bold mt-3"
       style={{
        fontFamily: "Sora",
        color: isDarkModeEnabled ? "var(--black-soft)" : "var(--purple-soft)",
       }}
      >
       {name}
      </h3>
   ...
   <main>{children}</main>
   {!home && <LinkButton href="/" text="← Back to home" />}
  </div>
 );
};
