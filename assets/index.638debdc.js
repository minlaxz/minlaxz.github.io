...
`,_=n.code`
color: red;
`,z=()=>(e.useEffect((()=>{window.document.title="minlaxz | About"}),[]),e.createElement(v,null,e.createElement(S,null,"Hello, world! in this page I've used styled components and ",e.createElement(_,null,"pre")),e.createElement($,null))),N=n.div`
    display: flex;
    flex-flow: column;
    flex-wrap: wrap;
    justify-content: center;
...
`,H=({markdown:t})=>e.createElement(A,null,e.createElement(r,null,t)),I=({name:t})=>e.createElement(e.Fragment,null,e.createElement(B,null,j.filter((e=>e.name===t)).map(((t,l)=>e.createElement(r,{key:l},t.r)))),e.createElement(T,null,j.filter((e=>e.name===t)).map((t=>t.p.map(((t,l)=>e.createElement(H,{markdown:t,key:l}))))))),M=n.img`
    width: 30vw;
...
`,G=()=>e.createElement(L,null,e.createElement("div",{style:{display:"flex",width:"100vw",flexDirection:"row",justifyContent:"space-evenly",marginTop:"1em"}},e.createElement($,{cusName:"Back to Home 🏡"}),e.createElement(O,{cusName:"Go to Repo List 👻"})),e.createElement(B,null,e.createElement(r,null,"### Howdy 😶‍🌫️ I am Min Min Latt (minlaxz) ☕")),e.createElement(r,null,"🕸 Here is my website (building): [minlaxz.me](https://minlaxz.me)"),e.createElement(I,{name:"connect"}),e.createElement(I,{name:"programming"}),e.createElement(I,{name:"others"}),e.createElement(I,{name:"osiot"}),e.createElement(M,{src:"https://metrics.lecoq.io/minlaxz",alt:"Github Metrics"}),e.createElement(M,{src:"https://github-readme-streak-stats.herokuapp.com/?user=minlaxz",alt:"Github Streak Stats"})),R=()=>e.createElement(s,null,e.createElement(m,{exact:!0,path:"/",component:w}),e.createElement(m,{exact:!0,path:"/repos",component:k}),e.createElement(m,{exact:!0,path:"/about",component:z}),e.createElement(m,{path:"/repos/:name",component:F}),e.createElement(m,{exact:!0,path:"/forhuman",component:G}),e.createElement(m,{component:x})),$=({cusName:t})=>e.createElement(o,{to:"/"},t||"Home 🏠"),O=({linkClass:t,cusName:l})=>e.createElement("span",null,"  ",e.createElement(o,{to:"/repos",className:t},l||"repo list 🤓")),J=({linkClass:t})=>e.createElement("span",null,"  ",e.createElement(o,{to:"/about",className:t},"Here")," is how this went through   🤔"),V=({linkClass:t,cusName:l})=>e.createElement("span",null,"  ",e.createElement(o,{to:"/forhuman",className:t},l||"markdown"));function P(){return e.createElement(c,{basename:"/"},e.createElement(R,null))}g.render(e.createElement(e.StrictMode,null,e.createElement(P,null)),document.getElementById("root"));
