...
`,u=({label:e})=>t.createElement(g,{src:`https://img.shields.io/badge/${e}-000?style=social&logo=markdown&logoColor=black`,alt:"Markdown"}),p=()=>{const[e,l]=t.useState(new Date),n=t.useCallback((()=>{l(new Date)}));return t.useEffect((()=>{let e=setInterval((()=>n()),1e3);return()=>clearInterval(e)}),[n]),t.createElement("span",null,e.toLocaleTimeString())},f=({to:e,text:l})=>t.createElement("a",{href:e,target:"_blank",rel:"noopener noreferrer"},l,t.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",style:{height:"16px",width:"16px"},fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},t.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"}))),b=e.div`
margin: 0;
padding: 0;
height: 100vh;
display: flex;
...
`,v=()=>{const[e,n]=t.useState(""),a="minlaxz.github.io";return t.useEffect((()=>{const e="https://microapi.octocat.tk/api/v1/github/lastcommit";console.log(`API: ${e}`);(async()=>{await l.get(`${e}`,{headers:{"Content-type":"application/json"},params:{repo:a,user:"minlaxz",branch:"main"}}).then((e=>n(e.data.data))).catch((e=>console.log(e)))})()}),[]),t.createElement("span",{style:{color:"red"}},t.createElement("small",null,t.createElement("a",{href:`https://github.com/minlaxz/${a}/commit/${e}`,rel:"noopener noreferrer",target:"_blank"},"CHECKSUM : ",e)))},C=()=>(t.useEffect((()=>{window.document.title="minlaxz | Home";const e=window.location.hostname,t=localStorage.getItem(e);if(window.scrollTo(0,0),t){const e=n(JSON.parse(t),(e=>{e.lastVisitedTime=Date.now()}));localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}else{const e={lastVisitedTime:Date.now()};localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}}),[]),t.createElement(t.Fragment,null,t.createElement(b,null,t.createElement("h3",null,"Hello, world! ((👻) => (minlaxz)) "),t.createElement("code",{style:{fontSize:"13px"}},"Welcome to my universe. ",t.createElement(p,null)),t.createElement(k,null,"You would visit to me with ",t.createElement(f,{to:"https://git.io/minlaxz",text:"git.io/minlaxz"})," if this url ",t.createElement("u",{style:{color:"hotpink"}},window.location.hostname)," is ",t.createElement("b",null,"long")," to remember for you 🥴"),t.createElement(k,null,"I am a so much responsive page! 👻"),t.createElement("p",null,"Source Code is hosted ",t.createElement(f,{to:"https://github.com/minlaxz/minlaxz.github.io",text:"here"})),t.createElement(y,null,"Available routes:",t.createElement(w,null,t.createElement(x,null,"View my =>",t.createElement(fe,{cusName:"Repo List 🥶"})),t.createElement(x,null,"Here is markdown => ",t.createElement(we,null)),t.createElement(x,null,"Other sites => ",t.createElement(be,null)),t.createElement(x,null,"Serverless Api Calls => ",t.createElement(xe,null)),t.createElement(x,null,"Link shortener => ",t.createElement(ye,null)))),t.createElement(y,null,"Other sites and backends ...",t.createElement(w,null,t.createElement(x,null,t.createElement(f,{to:"https://minlaxz.github.io",text:"with Github Pages"}),"minlaxz.github.io"===window.location.hostname?t.createElement("span",null,"  you're currently viewing"):t.createElement("span",null,"...")),t.createElement(x,null,t.createElement(f,{to:"https://gh-minlaxz.pages.dev",text:"with Cloudflare Pages (not yet)"})),t.createElement(x,null,t.createElement(f,{to:"https://lessapi.minlaxz.workers.dev",text:"CF backend 👻 (using workers)"})),t.createElement(x,null,t.createElement(f,{to:"https://microapi.octocat.tk",text:"Deta backend 👻 (using express)"})))),t.createElement("div",{style:{width:"80%",textAlign:"center",padding:"10px",fontSize:"14px"}},t.createElement("b",null,"React")," with ",t.createElement("b",null,"Vite")," as build tool, hosted on ",t.createElement("b",null,"Github Pages")," with ",t.createElement("b",null,"actions")," on ",t.createElement("b",null,"push")," on ",t.createElement("b",null,"main"),", SSL/TLS by ",t.createElement("b",null,"Cloudflare")," with ",t.createElement("b",null,"proxies"),"."),t.createElement(v,null)),t.createElement(E,null,t.createElement("div",{style:{border:"2px dotted khaki"}},t.createElement("small",null,"Well, actually I am hiding 🤓 not to distrurb you."),t.createElement(Ee,null))))),S=e.div`
margin:0;
padding:0;
display: flex;
...
`,R=()=>{const e=a();return t.useEffect((()=>{window.document.title="minlaxz | Oops!"}),[]),t.createElement(M,null,t.createElement(O,null,"Oops 😯! Well this is embarassing."),t.createElement("pre",null,"Not weed on this ",e.pathname),t.createElement(o,{to:"/"},"Home is safe 🤓"))},H=e.div`
margin: 0;
padding: 0;
display: flex;
flex-flow: column;
...
/* word-break: break-all; */
text-align: center;
`,le=()=>{let{name:e}=i();const[n,a]=t.useState(null);return t.useEffect((()=>{"minlaxz"!==e?(async()=>{const t=await l.get(`https://api.github.com/repos/minlaxz/${e}`);a(t.data)})():a({name:e})}),[]),n?t.createElement(t.Fragment,null,t.createElement(ee,null,"minlaxz"===n.name?t.createElement("pre",null,"This is personal repo"):t.createElement(t.Fragment,null,t.createElement("pre",null,"Name : ",n.name),t.createElement("pre",null,"Forked : ",n.fork?"True":"False"),t.createElement(te,null,"Description : ",n.description),t.createElement("pre",null,"Language : ",n.language),t.createElement("pre",null,"Repo Size : ",n.size," Kb"),t.createElement(te,null,"GithubURL : ",t.createElement("a",{href:n.html_url},n.html_url)),t.createElement("pre",null,"Website : ",t.createElement("a",{href:n.homepage},n.homepage)||"Not provided.")),t.createElement("hr",null),t.createElement("div",{style:{display:"flex",width:"100vw",flexDirection:"row",justifyContent:"space-evenly",marginBottom:"1em"}},t.createElement(fe,{cusName:"Back to Repo List 👻"}),t.createElement(pe,{cusName:"Go to Home 🏡"})))):t.createElement(t.Fragment,null,t.createElement("p",null,"Fetching..."),t.createElement(fe,null),t.createElement(pe,null))},ne=e.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: flex-start;    
...
`,ce=()=>{const[e,n]=t.useState(""),[a,o]=t.useState(""),[r,i]=t.useState(null),[s,c]=t.useState(!1);return t.useEffect((()=>{console.log(e);["fuck","sex","nude"].includes(e)?c(!0):c(!1)}),[e]),t.createElement(ne,null,t.createElement("h3",null,"You're gonna make serverless api request 👻"),t.createElement(P,null,t.createElement(pe,{cusName:"Return Home 😭"}),t.createElement(we,{cusName:"To markdown 🥶"}),t.createElement(fe,{cusName:"To Repos 📑"})),t.createElement(re,null,t.createElement(ie,{type:"text",placeholder:"Search images",onChange:e=>n(e.target.value)}),t.createElement(se,{danger:s,onClick:async()=>{i(null),o("Pwease wait 👻 ... ");const t=await(async({query:e})=>{try{const t="https://lessapi.minlaxz.workers.dev/api/images";return(await l.post(`${t}`,{headers:{"Content-type":"application/json;charset=UTF-8"},query:e})).data}catch(t){return void o(JSON.stringify(t.message))}})({query:e});i(t)}},`Search ${e} images`)),t.createElement(ae,null,r?r.map((e=>t.createElement("a",{key:e.id,href:`https://unsplash.com/photos/${e.id}`,target:"_blank",rel:"noopener noreferrer"},t.createElement(oe,{src:e.src,alt:e.alt})))):t.createElement("p",null,a)))};e.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: flex-start;
