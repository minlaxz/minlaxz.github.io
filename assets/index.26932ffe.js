...
align-items: center;
justify-content: center;
`,P=()=>e.createElement(J,null,e.createElement("h3",null,"Other Websites")),V=t.img`
    width: 120px;
    @media only screen and (max-width: 768px) {
        width: 90px;
    }
...
`,W=({label:t})=>e.createElement(V,{src:`https://img.shields.io/badge/${t}-000?style=social&logo=markdown&logoColor=black`,alt:"Markdown"}),$=()=>e.createElement(s,null,e.createElement(m,{exact:!0,path:"/",component:y}),e.createElement(m,{exact:!0,path:"/repos",component:S}),e.createElement(m,{exact:!0,path:"/about",component:F}),e.createElement(m,{path:"/repos/:name",component:B}),e.createElement(m,{exact:!0,path:"/forhuman",component:R}),e.createElement(m,{exact:!0,path:"/othersites",component:P}),e.createElement(m,{component:C})),q=({cusName:t})=>e.createElement(a,{to:"/"},t||"Default Home 🏠"),K=({linkClass:t,cusName:l})=>e.createElement("span",null,"  ",e.createElement(a,{to:"/repos",className:t},l||"repo list 🤓")),U=({linkClass:t,cusName:l})=>e.createElement("span",null,"  ",e.createElement(a,{to:"/othersites",className:t},l||"Other websites")),Q=({linkClass:t})=>e.createElement("span",null,"  ",e.createElement(a,{to:"/about",className:t},"Here")," is how this went through   🤔"),Y=({linkClass:t,cusName:l})=>e.createElement(a,{to:"/forhuman",className:t},e.createElement(W,{label:l||"View Markdown"}));function X(){return e.createElement(c,{basename:"/"},e.createElement($,null))}g.render(e.createElement(e.StrictMode,null,e.createElement(X,null)),document.getElementById("root"));
