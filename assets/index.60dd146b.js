...
`,v=()=>{const[e,a]=t.useState(""),n="minlaxz.github.io";return t.useEffect((()=>{(async()=>{await l.get("https://microapi.octocat.tk/api/v1/github/lastcommit",{headers:{"Content-type":"application/json"},params:{repo:n,user:"minlaxz",branch:"main"}}).then((e=>a(e.data.data))).catch((e=>console.log(e)))})()}),[]),t.createElement("span",{style:{color:"red"}},t.createElement("small",null,t.createElement("a",{href:`https://github.com/minlaxz/${n}/commit/${e}`,rel:"noopener noreferrer",target:"_blank"},"CHECKSUM : ",e)))},C=()=>(t.useEffect((()=>{window.document.title="minlaxz | Home";const e=window.location.hostname,t=localStorage.getItem(e);if(window.scrollTo(0,0),t){const e=a(JSON.parse(t),(e=>{e.lastVisitedTime=Date.now()}));localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}else{const e={lastVisitedTime:Date.now()};localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}}),[]),t.createElement(t.Fragment,null,t.createElement(b,null,t.createElement("h3",null,"Hello, world! ((👻) => (minlaxz)) "),t.createElement("code",{style:{fontSize:"13px"}},"Welcome to my universe. ",t.createElement(p,null)),t.createElement(k,null,"You would visit to me with ",t.createElement(f,{to:"https://git.io/minlaxz",text:"git.io/minlaxz"})," if this url ",t.createElement("u",{style:{color:"hotpink"}},window.location.hostname)," is ",t.createElement("b",null,"long")," to remember for you 🥴"),t.createElement(k,null,"I am a so much responsive page! 👻"),t.createElement("p",null,"Source Code is hosted ",t.createElement(f,{to:"https://github.com/minlaxz/minlaxz.github.io",text:"here"})),t.createElement(y,null,"Available routes:",t.createElement(w,null,t.createElement(x,null,"View my =>",t.createElement(fe,{cusName:"Repo List 🥶"})),t.createElement(x,null,"Here is markdown => ",t.createElement(we,null)),t.createElement(x,null,"Other sites => ",t.createElement(be,null)),t.createElement(x,null,"Serverless Api Calls => ",t.createElement(xe,null)),t.createElement(x,null,"Link shortener => ",t.createElement(ye,null)))),t.createElement(y,null,"This page should also be available at...",t.createElement(w,null,t.createElement(x,null,t.createElement(f,{to:"https://minlaxz.github.io",text:"with Github Pages"}),"github.minlaxz.me"===window.location.hostname?t.createElement("span",null,"  you're currently viewing"):t.createElement("span",null,"  hostname does not match")),t.createElement(x,null,t.createElement(f,{to:"https://gh-minlaxz.pages.dev",text:"with Cloudflare Pages (not yet)"})),t.createElement(x,null,t.createElement(f,{to:"https://lessapi.minlaxz.workers.dev",text:"CF backend 👻 (using workers)"})),t.createElement(x,null,t.createElement(f,{to:"https://microapi.octocat.tk",text:"Deta backend 👻 (using express)"})))),t.createElement("div",{style:{width:"80%",textAlign:"center",padding:"10px",fontSize:"14px"}},t.createElement("b",null,"React")," with ",t.createElement("b",null,"Vite")," as build tool, hosted on ",t.createElement("b",null,"Github Pages")," with ",t.createElement("b",null,"actions")," on ",t.createElement("b",null,"push")," on ",t.createElement("b",null,"main"),", SSL/TLS by ",t.createElement("b",null,"Cloudflare")," with ",t.createElement("b",null,"proxies"),"."),t.createElement(v,null)),t.createElement(E,null,t.createElement("div",{style:{border:"2px dotted khaki"}},t.createElement("small",null,"Well, actually I am hiding 🤓 not to distrurb you."),t.createElement(Ee,null))))),S=e.div`
margin:0;
padding:0;
display: flex;
