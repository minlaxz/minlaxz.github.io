import{s as e,R as t,a as l,p as a,u as n,L as o,M as r,b as i,S as s,c as m,H as c,d}from"./vendor.3782532a.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver((e=>{for(const l of e)if("childList"===l.type)for(const e of l.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&t(e)})).observe(document,{childList:!0,subtree:!0})}function t(e){if(e.ep)return;e.ep=!0;const t=function(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),"use-credentials"===e.crossorigin?t.credentials="include":"anonymous"===e.crossorigin?t.credentials="omit":t.credentials="same-origin",t}(e);fetch(e.href,t)}}();const h=e.img`
    width: 120px;
...
`,k=()=>{const[e,a]=t.useState(""),n="minlaxz.github.io";return t.useEffect((()=>{(async()=>{await l.get("https://lessapi.minlaxz.workers.dev/api/github/lastcommit",{headers:{"Content-type":"application/json"},params:{repo:n,user:"minlaxz",branch:"main"}}).then((e=>a(e.data.sha))).catch((e=>console.log(e)))})()}),[]),t.createElement("span",{style:{color:"red"}},t.createElement("small",null,t.createElement("a",{href:`https://github.com/minlaxz/${n}/commit/${e}`,rel:"noopener noreferrer",target:"_blank"},"CHECKSUM : ",e)))},v=()=>(t.useEffect((()=>{window.document.title="minlaxz | Home";const e=window.location.hostname,t=localStorage.getItem(e);if(window.scrollTo(0,0),t){const e=a(JSON.parse(t),(e=>{e.lastVisitedTime=Date.now()}));localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}else{const e={lastVisitedTime:Date.now()};localStorage.setItem("minlaxz.github.io",JSON.stringify(e))}}),[]),t.createElement(t.Fragment,null,t.createElement(f,null,t.createElement("h3",null,"Hello, world! ((👻) => (minlaxz)) "),t.createElement("code",{style:{fontSize:"13px"}},"Welcome to my universe. ",t.createElement(u,null)),t.createElement(x,null,"You would visit to me with ",t.createElement(p,{to:"https://git.io/minlaxz",text:"git.io/minlaxz"})," if this url ",t.createElement("u",{style:{color:"hotpink"}},window.location.hostname)," is ",t.createElement("b",null,"long")," to remember for you 🥴"),t.createElement(x,null,"I am a so much responsive page! 👻"),t.createElement("p",null,"Source Code is hosted ",t.createElement(p,{to:"https://github.com/minlaxz/minlaxz.github.io",text:"here"})),t.createElement(y,null,"Available routes:",t.createElement(b,null,t.createElement(w,null,"View my =>",t.createElement(de,{cusName:"Repo List 🥶"})),t.createElement(w,null,"Here is markdown => ",t.createElement(pe,null)),t.createElement(w,null,"Other sites => ",t.createElement(he,null)),t.createElement(w,null,"Serverless Api Calls => ",t.createElement(ge,null)))),t.createElement(y,null,"This page should also be available at...",t.createElement(b,null,t.createElement(w,null,t.createElement(p,{to:"https://minlaxz.github.io",text:"with Github Pages"}),"github.minlaxz.me"===window.location.hostname?t.createElement("span",null,"  you're currently viewing"):t.createElement("span",null,"  hostname does not match")),t.createElement(w,null,t.createElement(p,{to:"https://gh-minlaxz.pages.dev",text:"with Cloudflare Pages (not yet)"})),t.createElement(w,null,t.createElement(p,{to:"https://lessapi.minlaxz.workers.dev",text:"here is my backend 👻"})))),t.createElement("div",{style:{width:"80%",textAlign:"center",padding:"10px",fontSize:"14px"}},t.createElement("b",null,"React")," with ",t.createElement("b",null,"Vite")," as build tool, hosted on ",t.createElement("b",null,"Github Pages")," with ",t.createElement("b",null,"actions")," on ",t.createElement("b",null,"push")," on ",t.createElement("b",null,"main"),", SSL/TLS by ",t.createElement("b",null,"Cloudflare")," with ",t.createElement("b",null,"proxies"),"."),t.createElement(k,null)),t.createElement(E,null,t.createElement("div",{style:{border:"2px dotted khaki"}},t.createElement("small",null,"Well, actually I am hiding 🤓 not to distrurb you."),t.createElement(ue,null))))),C=e.div`
margin:0;
padding:0;
display: flex;
...
align-items: center;
justify-content: center;
`,B=()=>t.createElement(A,null,t.createElement("h3",null,"Other Websites")),I=e.div`
    margin: 0%;
    padding: 0%;
    display: flex;
...
`,H=()=>{const e=n();return t.useEffect((()=>{window.document.title="minlaxz | Oops!"}),[]),t.createElement(I,null,t.createElement(M,null,"Oops 😯! Well this is embarassing."),t.createElement("pre",null,"Not weed on this ",e.pathname),t.createElement(o,{to:"/"},"Home is safe 🤓"))},O=e.div`
margin: 0;
padding: 0;
display: flex;
flex-flow: column;
...
`,Y=({markdown:e})=>t.createElement(K,null,t.createElement(r,null,e)),Q=({name:e})=>t.createElement(t.Fragment,null,t.createElement(V,null,q.filter((t=>t.name===e)).map(((e,l)=>t.createElement(r,{key:l},e.r)))),t.createElement(W,null,q.filter((t=>t.name===e)).map((e=>e.p.map(((e,l)=>t.createElement(Y,{markdown:e,key:l}))))))),X=()=>(t.useEffect((()=>{window.document.title="minlaxz | markdown"}),[]),t.createElement(J,null,t.createElement($,null,t.createElement(ce,{cusName:"Back to Home 🏡"}),t.createElement(de,{cusName:"Go to Repo List 👻"})),t.createElement(V,null,t.createElement(r,null,"### Howdy 😶‍🌫️ I am Min Min Latt (minlaxz) ☕")),t.createElement(r,null,"🕸 Here is my website (building): [minlaxz.me](https://minlaxz.me)"),t.createElement(Q,{name:"connect"}),t.createElement(Q,{name:"programming"}),t.createElement(Q,{name:"others"}),t.createElement(Q,{name:"osiot"}),t.createElement(U,{src:"https://metrics.lecoq.io/minlaxz",alt:"Github Metrics"}),t.createElement(U,{src:"https://github-readme-streak-stats.herokuapp.com/?user=minlaxz",alt:"Github Streak Stats"}))),Z=e.div`
display: flex;
flex-flow: column;
flex-wrap: wrap;
justify-content: center;
...
`,se=()=>{const[e,a]=t.useState(""),[n,o]=t.useState(""),[r,i]=t.useState(null),[s,m]=t.useState(!1);return t.useEffect((()=>{console.log(e);["fuck","sex","nude"].includes(e)?m(!0):m(!1)}),[e]),t.createElement(le,null,t.createElement("h3",null,"You're gonna make serverless api request 👻"),t.createElement($,null,t.createElement(ce,{cusName:"Return Home 😭"}),t.createElement(pe,{cusName:"To markdown 🥶"}),t.createElement(de,{cusName:"To Repos 📑"})),t.createElement(oe,null,t.createElement(re,{type:"text",placeholder:"Search images",onChange:e=>a(e.target.value)}),t.createElement(ie,{danger:s,onClick:async()=>{i(null),o("Pwease wait 👻 ... ");const t=await(async({query:e})=>{try{const t="https://lessapi.minlaxz.workers.dev/api/images";return(await l.post(`${t}`,{headers:{"Content-type":"application/json;charset=UTF-8"},query:e})).data}catch(t){return void o(JSON.stringify(t.message))}})({query:e});i(t)}},`Search ${e} images`)),t.createElement(ae,null,r?r.map((e=>t.createElement("a",{key:e.id,href:`https://unsplash.com/photos/${e.id}`,target:"_blank",rel:"noopener noreferrer"},t.createElement(ne,{src:e.src,alt:e.alt})))):t.createElement("p",null,n)))},me=()=>t.createElement(s,null,t.createElement(m,{exact:!0,path:"/",component:v}),t.createElement(m,{exact:!0,path:"/about",component:T}),t.createElement(m,{exact:!0,path:"/othersites",component:B}),t.createElement(m,{exact:!0,path:"/repos",component:P}),t.createElement(m,{path:"/repos/:name",component:te}),t.createElement(m,{exact:!0,path:"/forhuman",component:X}),t.createElement(m,{exact:!0,path:"/serverless",component:se}),t.createElement(m,{component:H})),ce=({cusName:e})=>t.createElement(o,{to:"/"},e||"Default Home 🏠"),de=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/repos",className:e},l||"repo list 🤓")),he=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/othersites",className:e},l||"Other websites")),ge=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/serverless",className:e},l||"Serverless API")),ue=({linkClass:e})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/about",className:e},"Here")," is how this went through   🤔"),pe=({linkClass:e,cusName:l})=>t.createElement(o,{to:"/forhuman",className:e},t.createElement(g,{label:l||"View Markdown"}));function fe(){return t.createElement(c,{basename:"/"},t.createElement(me,null))}d.render(t.createElement(t.StrictMode,null,t.createElement(fe,null)),document.getElementById("root"));
