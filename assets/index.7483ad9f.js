...
margin: 0.5em;
padding: 0.5em;
`,D=({tech:e})=>t.createElement(F,null,e),_=({children:e,head:l})=>t.createElement(L,null,l,t.createElement(j,null,e)),A=()=>(t.useEffect((()=>{window.document.title="minlaxz | About this"}),[]),t.createElement(S,null,t.createElement(_,{head:"I've used the following tools"},t.createElement(D,{tech:"React for fontend"}),t.createElement(D,{tech:"styled componenet for CSS"}),t.createElement(D,{tech:"Vite as build tool"}),t.createElement(D,{tech:"React hash router for frontend routing"})),t.createElement(_,{head:"I've used these for domain"},t.createElement(D,{tech:"This is hosted on github pages"}),t.createElement(D,{tech:"This is also hosted on cloudflare pages"}),t.createElement(D,{tech:"used CNAME for domain routing"})),t.createElement(_,{head:"What is cool ..?"},t.createElement(D,{tech:"Clock is about Javascript Closures"}),t.createElement(D,{tech:"Repo page is about axios with useEffect()"}),t.createElement(D,{tech:"Markdown page is about map() and filter()"}),t.createElement(D,{tech:"gh-pages package is cool but this used Github actions workflow"})),t.createElement(z,null,t.createElement(N,null,"I will made a backend for this 🤪")),t.createElement(fe,{cusName:"Back to Home"}))),T=e.div`
margin: 0;
padding: 0;
height: 100vh;
display: flex;
...
align-items: center;
justify-content: center;
`,B=()=>t.createElement(T,null,t.createElement("h3",null,"Other Websites")),I=e.div`
    margin: 0%;
    padding: 0%;
    display: flex;
...
`,H=()=>{const e=n();return t.useEffect((()=>{window.document.title="minlaxz | Oops!"}),[]),t.createElement(I,null,t.createElement($,null,"Oops 😯! Well this is embarassing."),t.createElement("pre",null,"Not weed on this ",e.pathname),t.createElement(o,{to:"/"},"Home is safe 🤓"))},M=e.div`
margin: 0;
padding: 0;
display: flex;
flex-flow: column;
...
/* word-break: break-all; */
text-align: center;
`,le=()=>{let{name:e}=i();const[a,n]=t.useState(null);return t.useEffect((()=>{"minlaxz"!==e?(async()=>{const t=await l.get(`https://api.github.com/repos/minlaxz/${e}`);n(t.data)})():n({name:e})}),[]),a?t.createElement(t.Fragment,null,t.createElement(ee,null,"minlaxz"===a.name?t.createElement("pre",null,"This is personal repo"):t.createElement(t.Fragment,null,t.createElement("pre",null,"Name : ",a.name),t.createElement("pre",null,"Forked : ",a.fork?"True":"False"),t.createElement(te,null,"Description : ",a.description),t.createElement("pre",null,"Language : ",a.language),t.createElement("pre",null,"Repo Size : ",a.size," Kb"),t.createElement(te,null,"GithubURL : ",t.createElement("a",{href:a.html_url},a.html_url)),t.createElement("pre",null,"Website : ",t.createElement("a",{href:a.homepage},a.homepage)||"Not provided.")),t.createElement("hr",null),t.createElement("div",{style:{display:"flex",width:"100vw",flexDirection:"row",justifyContent:"space-evenly",marginBottom:"1em"}},t.createElement(Ee,{cusName:"Back to Repo List 👻"}),t.createElement(fe,{cusName:"Go to Home 🏡"})))):t.createElement(t.Fragment,null,t.createElement("p",null,"Fetching..."),t.createElement(Ee,null),t.createElement(fe,null))},ae=e.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: flex-start;    
...
`;var he="_short_link_button_1a808_1",ge="_disabled_1a808_19";const ue=()=>{const[e,a]=t.useState(""),[n,o]=t.useState(!1),[r,i]=t.useState(""),[c,m]=t.useState(!1);t.useEffect((()=>{s.exports.isURL(e,{protocols:["http","https"],require_protocol:!0})?(a(e),o(!1)):o(!0)}),[e]);return t.createElement(me,null,t.createElement("h4",null,"it's me link shotener 👻 currently building..."),t.createElement(de,{b_points:"768",value:e,onChange:e=>a(e.target.value)}),t.createElement("button",{onClick:async()=>{m(!0),a("");const t="https://api.octocat.tk/r";console.log(t);try{const a=await l.post(`${t}`,{Headers:{"Content-Type":"application/json"},url:e});i(a.data.slug)}catch(n){console.log(n)}m(!1)},className:`${he} ${n&&`${ge}`}`,disabled:n}," Shorten"),r&&t.createElement("span",null,`https://api.octocat.tk/r/${r}`),c&&t.createElement("span",null,t.createElement("i",{className:"fas fa-spinner fa-spin"})),t.createElement(P,null,t.createElement(fe,{cusName:"Well, Go back 🏡"})))},pe=()=>t.createElement(c,null,t.createElement(m,{exact:!0,path:"/",component:C}),t.createElement(m,{exact:!0,path:"/about",component:A}),t.createElement(m,{exact:!0,path:"/othersites",component:B}),t.createElement(m,{exact:!0,path:"/repos",component:q}),t.createElement(m,{path:"/repos/:name",component:le}),t.createElement(m,{exact:!0,path:"/forhuman",component:Z}),t.createElement(m,{exact:!0,path:"/serverless",component:ce}),t.createElement(m,{exact:!0,path:"/shortlink",component:ue}),t.createElement(m,{component:H})),fe=({cusName:e})=>t.createElement(o,{to:"/"},e||"Default Home 🏠"),Ee=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/repos",className:e},l||"repo list 🤓")),be=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/othersites",className:e},l||"Other websites")),we=({linkClass:e})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/about",className:e},"Here")," is how this went through   🤔"),xe=({linkClass:e,cusName:l})=>t.createElement(o,{to:"/forhuman",className:e},t.createElement(u,{label:l||"View Markdown"})),ye=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/serverless",className:e},l||"Serverless API")),ke=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/shortlink",className:e},l||"LinkShortener API"));function ve(){return t.createElement(d,{basename:"/"},t.createElement(pe,null))}h.render(t.createElement(t.StrictMode,null,t.createElement(ve,null)),document.getElementById("root"));
