...
`,se=()=>{const[e,a]=t.useState(""),[n,o]=t.useState(""),[i,r]=t.useState(null),[s,m]=t.useState(!1);return t.useEffect((()=>{console.log(e);["fuck","sex","nude"].includes(e)?m(!0):m(!1)}),[e]),t.createElement(le,null,t.createElement("h3",null,"You're gonna make serverless api request 👻"),t.createElement(J,null,t.createElement(ce,{cusName:"Return Home 😭"}),t.createElement(pe,{cusName:"To markdown 🥶"}),t.createElement(de,{cusName:"To Repos 📑"})),t.createElement(oe,null,t.createElement(ie,{type:"text",placeholder:"Search images",onChange:e=>a(e.target.value)}),t.createElement(re,{danger:s,onClick:async()=>{r(null),o("Pwease wait 👻 ... ");const t=await(async({query:e})=>{await l.post("https://lessapi.minlaxz.workers.dev/api/images",{headers:{"Content-type":"application/json;charset=UTF-8"},query:e}).then((e=>e.data)).catch((e=>o(JSON.stringify(e.message))))})({query:e});r(t)}},`Search ${e} images`)),t.createElement(ae,null,i?i.map((e=>t.createElement("a",{key:e.id,href:`https://unsplash.com/photos/${e.id}`,target:"_blank",rel:"noopener noreferrer"},t.createElement(ne,{src:e.src,alt:e.alt})))):t.createElement("p",null,n)))},me=()=>t.createElement(s,null,t.createElement(m,{exact:!0,path:"/",component:v}),t.createElement(m,{exact:!0,path:"/about",component:T}),t.createElement(m,{exact:!0,path:"/othersites",component:A}),t.createElement(m,{exact:!0,path:"/repos",component:P}),t.createElement(m,{path:"/repos/:name",component:te}),t.createElement(m,{exact:!0,path:"/forhuman",component:X}),t.createElement(m,{exact:!0,path:"/serverless",component:se}),t.createElement(m,{component:M})),ce=({cusName:e})=>t.createElement(o,{to:"/"},e||"Default Home 🏠"),de=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/repos",className:e},l||"repo list 🤓")),he=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/othersites",className:e},l||"Other websites")),ge=({linkClass:e,cusName:l})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/serverless",className:e},l||"Serverless API")),ue=({linkClass:e})=>t.createElement("span",null,"  ",t.createElement(o,{to:"/about",className:e},"Here")," is how this went through   🤔"),pe=({linkClass:e,cusName:l})=>t.createElement(o,{to:"/forhuman",className:e},t.createElement(g,{label:l||"View Markdown"}));function fe(){return t.createElement(c,{basename:"/"},t.createElement(me,null))}d.render(t.createElement(t.StrictMode,null,t.createElement(fe,null)),document.getElementById("root"));
